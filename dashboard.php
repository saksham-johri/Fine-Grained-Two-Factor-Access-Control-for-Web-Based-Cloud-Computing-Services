		...
		<div id="header">
			<div class="shell">
				...
				<div id="top">
					...
					<div id="top-navigation"> Welcome <a href="#"><strong><?php echo ucfirst($user_row['profile_name']); ?></strong></a> <span>|</span> <a href="#">Help</a> <span>|</span> <a href="#">Profile Settings</a> <span>|</span> <a href="logout.php">Log out</a> </div>
				</div>
				<!-- End Logo + Top Nav -->
				<!-- Main Nav -->
				<div id="navigation">
														...
														if($object['Key'] != $folder){
															...
															if(substr($object['Key'], -1) == '/'){
																...
																echo $str .'</a></h3></td>
																	<td>xx.xx.xx</td>
																	<td>Administrator</td>
																	<td><a href="#" onclick="del(\'' . $object["Key"] . '\')" class="ico del">Delete</a><a href="#" onclick="download(\'' . $object["Key"] . '\')" class="ico edit">Download</a></td>
																</tr>
																';
															}
														}else{
